    ...
    <main class="main-content">
        ...
        <section class="content fade-in">
            <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem;">
                <a href="{{ route('semaforo2.semaforo2_login') }}" class="btn-custom btn-success">
            ...
            <h2 style="margin-bottom: 1.5rem;"><i class="fas fa-list-ul"></i> Lista de Semaforo de Vehículos 2</h2>
            ...
            <form method="GET" action="{{ route('semaforo2.registro_semaforo2') }}">
                                ...
                                <tr class="semaforo-row">
                                    ...
                                    <td>
                                        <div class="actions-container">
                                            <a href="{{ route('semaforo2.detalle_semaforo2', ['Id_semaforo2' => $item['Id_semaforo2']]) }}" class="action-btn view tooltip" data-tooltip="Ver detalles">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('semaforo2.editar_semaforo2', ['Id_semaforo2' => $item['Id_semaforo2']]) }}" class="action-btn edit tooltip" data-tooltip="Editar semáforo">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <button class="action-btn delete tooltip" 
                                                data-tooltip="Eliminar semáforo" 
                                                onclick="confirmDelete(event, '{{ route('deleteSema2', ['Id_semaforo2' => $item['Id_semaforo2']]) }}')">
...
<script>
    document.getElementById('downloadPdfBtn').addEventListener('click', function () {
        ...
        pdf.text('Reporte de Semáforos Vehiculos 2', 14, 20);
        ...
        // Descargar el PDF
        pdf.save('Semaforos Vehiculos 2.pdf');
    });
</script>
...
<script>
    document.getElementById('downloadExcelBtn').addEventListener('click', function () {
        ...
        XLSX.writeFile(workbook, 'Registro de Semaforo Vehiculos2.xlsx');
    });
</script>
