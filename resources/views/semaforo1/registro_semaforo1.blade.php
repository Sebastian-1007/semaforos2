    ...
    <main class="main-content">
        ...
        <section class="content fade-in">
            <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem;">
                <a href="{{ route('semaforo1.semaforo1_login') }}" class="btn-custom btn-success">
            ...
            <h2 style="margin-bottom: 1.5rem;"><i class="fas fa-list-ul"></i> Lista de Semaforo de Vehículos 1</h2>
            ...
            <form method="GET" action="{{ route('semaforo1.registro_semaforo1') }}">
                                ...
                                <tr class="semaforo-row">
                                    ...
                                    <td>
                                        <div class="actions-container">
                                            <a href="{{ route('semaforo1.detalle_semaforo1', ['Id_semaforo1' => $item['Id_semaforo1']]) }}" class="action-btn view tooltip" data-tooltip="Ver detalles">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('semaforo1.editar_semaforo1', ['Id_semaforo1' => $item['Id_semaforo1']]) }}" class="action-btn edit tooltip" data-tooltip="Editar semáforo">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <button class="action-btn delete tooltip" 
                                                data-tooltip="Eliminar semáforo" 
                                                onclick="confirmDelete(event, '{{ route('deleteSema', ['Id_semaforo1' => $item['Id_semaforo1']]) }}')">
...
<script>
    document.getElementById('downloadPdfBtn').addEventListener('click', function () {
        ...
        pdf.text('Reporte de Semáforos Vehiculos 1', 14, 20);
        ...
        // Descargar el PDF
        pdf.save('Semaforos Vehiculos 1.pdf');
    });
</script>
...
<script>
    document.getElementById('downloadExcelBtn').addEventListener('click', function () {
        ...
        XLSX.writeFile(workbook, 'Registro de Semaforo Vehiculos1.xlsx');
    });
</script>
